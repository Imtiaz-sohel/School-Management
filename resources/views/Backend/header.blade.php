    ...
    <nav class="navbar navbar-static-top pl-30">
        ...
        <ul class="nav navbar-nav">
            ...
            <a
                ...
                title="User"
            >
            <img class="rounded-circle" src="{{ (!empty(Auth::user()->image))?asset('upload/user_img/'.Auth::user()->image):asset('upload/no_image.jpg') }}" alt="User Avatar">
            </a>
            <ul class="dropdown-menu animated flipInX">
                <li class="user-body">
                <a class="dropdown-item" href="#"
                    ><i class="ti-user text-muted mr-2"></i>{{ Auth::user()->name }}</a
                >
                <a class="dropdown-item" href="#"
