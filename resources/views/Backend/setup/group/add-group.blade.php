        ...
        <section class="content">
            ...
            <!-- /.box-header -->
              <div class="box-body">
                <div class="row">
                  <div class="col">
                    <form action="{{ route('addGroupPost') }}" method="POST">
                      @csrf
                      <div class="row">
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="group_name" id="group_name" value="{{ old('group_name') }}" required class="form-control @error('group_name') is-inavlid @enderror" placeholder="group name">
                              @error('group_name')
